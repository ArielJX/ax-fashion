<?php get_header() ?>
  ...
  <div class="hero-fullscreen">
    <div class="hero-fullscreen_left">
      <img class="hero-fullscreen_left__image" src="<?php echo get_template_directory_uri(); ?>/images/fas.png" alt="" />
      <button class="button-black"><p>ACCOUNT</p></button>
    </div>
...
<section class="my-4">
  <div class="max-width-1024 center">
...
<section class="banner-blue">
  <div class="max-width-1024 center">
    <h3 class="home-title">Accessory</h3>
    <div class="row-3">
      <div class="card relative">
        <div class="wrapper-pink card-wrapper">
          <img src="<?php echo get_template_directory_uri(); ?>/images/dress.png" alt="">
          <button class="button-highlight absolute">BAGS</button>
        </div>
      </div>
      <div class="card relative">
        <div class="wrapper-pink card-wrapper">
          <img src="<?php echo get_template_directory_uri(); ?>/images/dress.png" alt="">
          <button class="button-highlight absolute">HATS</button>
        </div>
      </div>
      <div class="card relative">
        <div class="wrapper-pink card-wrapper">
          <img src="<?php echo get_template_directory_uri(); ?>/images/dress.png" alt="">
          <button class="button-highlight absolute">GLASSES</button>
        </div>
      </div>
    </div>
   <button class="button-discovery button-highlight"> <a href="http://ax-fashion.local/shop">DISCOVERY MORE</a></button>
  ...
  <div class="max-width-1024 center">
    ...
    <div class="row-3">
      <div class="card">
        ...
        <p class="card-title">CREAM WHITE HOODIE</p>
      ...
      <div class="card">
        ...
        <p class="card-title">FLORIAL SHIRT WITH PLEATED</p>
        <p class="card-price">NZD $160.00</p>
      </a>  
      </div>
      <div class="card">
        ...
        <p class="card-title">WHITE DRESS WITH PAISLEY PRINTS</p>
        <p class="card-price">NZD $280.00</p>
      </a></div>
    </div>  
  </div>
</section>
